...
$bulk_images = array();
$query1 = "SELECT " . $table_schedule_content . ".*," . $table_admin . ".First_Name," . $table_admin . ".Last_Name FROM " . $table_schedule_content . " LEFT JOIN " . $table_admin . " ON "
    . $table_admin . ".ID=" . $table_schedule_content . ".Login_User_ID where " . $table_schedule_content . ".ID='$entry_id' limit 1";
...
if (mysqli_num_rows($res1) > 0) {
    while ($row1 = mysqli_fetch_array($res1)) {
        ...
        $minute = date('i', $time);
        $fom = date('a', $time);
        $Schedule_Time_format = $day . '/' . $month . '/' . $year . ' ' . $hour . ':' . $minute . ' ' . $fom;
        $Content_Type = $row1["Content_Type"];
        if ($Content_Type == 1) {
            $query2 = "SELECT Attachment FROM " . $table_schedule_content_attachment . " where Content_ID='$entry_id' and Status!=3";
            echo $query2;
...
<link href="assets/plugins/bootstrap-datetimepicker/build/css/bootstrap-datetimepicker.min.css" rel="stylesheet" type="text/css" />
            ...
            <div class="row">
                ...
                <div class="col-lg-8 screen">
                    <div class="card-box">
                        ...
                        <form id="db_entry_form" action="schedule_content_entry.php" enctype="multipart/form-data" class="form-horizontal form-align" method="post" data-parsley-validate novalidate>
                            ...
                            <div class="row">
                                <div class="col-lg-11">
                                    <div class="form-group font-karla">
                                        <label for="scheduleTime">Schedule Time<span class="text-red">*</span></label>
                                        <!-- <input type="text" class="form-control" parsley-trigger="change" required onchange="scheduleTime(this.value)" name="Schedule_Time" id="schedule-date" value="<?php echo $Schedule_Time_format; ?>"> -->
                                        <input type="text" class="form-control" parsley-trigger="change" required name="Schedule_Time" id="schedule-date" value="<?php echo $Schedule_Time_format; ?>">
                                        <span id="errScheduleTime"></span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-11">
                                    <div class="form-group font-karla">
                                        ...
                                        <input type="text" name="Content_Title" parsley-trigger="change" required onkeyup="validateContentTitle(this.value)" placeholder="Content Title" class="form-control" id="Group_Name" value="<?= $Content_Title; ?>">
                            ...
                            <div class="row">
                                <div class="col-lg-11">
                                    <div class="form-group font-karla">
                                        ...
                                        <textarea class="form-control" name="Content_Description" id="text-description" placeholder="Content Description" parsley-trigger="change" style="resize:none" required rows="3"><?= $Content_Description ?></textarea>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row" id="single-Image" <?php if ($Content_Type == 1 && $img_uploaded != '') echo 'style="display:block;"';
                                                                else  echo 'style="display:none;"'; ?>>

                                <div class="col-lg-3 font-karla">
                                    <div class="form-group">
                                        <span onclick="RemoveImage('<?php echo $img_uploaded; ?>')">
                                            <i class="fa fa-times" aria-hidden="true" title="Delete Image" style="float:right;cursor:pointer"></i></span>
                                        <?php
                                        $image = "";
                                        if ($img_uploaded != "") {
                                        ...
                                        ?>
                                        <img src="<?php echo $image; ?>" class="img-responsive uploaded-images" alt="">
                                    </div>
                                </div>
                            </div>


                            <div class="row" <?php if ($Content_Type == 2 && $url_display != '') echo 'style="display:block;"';
                                                else  echo 'style="display:none;"'; ?>>
                            ...
                            <div class="row m-b-30 font-karla" <?php if ($Content_Type == 3) echo 'style="display:block;"';
                                                                else  echo 'style="display:none;"'; ?>>
                                <?php
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-11 font-karla" id="images" <?php if ($Content_Type == 1) echo 'style="display:block;"';
                                                                                else  echo 'style="display:none;"'; ?>>
                                    <div class="form-group">
                                ...
                                <div class="col-lg-11" id="video" <?php if ($Content_Type == 2) echo 'style="display:block;"';
                                                                    else  echo 'style="display:none;"'; ?>>
                                    <div class="form-group">
                                        <!--type="url"  parsley-type="url"-->
                                        <input type="text" name="Video_URL" id="Video_URL" <?php if ($Content_Type == 2) echo 'required="required;"'; ?> placeholder="Video URL" class="form-control" value="<?php echo $url_attachment ?>">
                                    </div>
                                </div>

                                <div class="col-lg-11" id="bulk_images" <?php if ($Content_Type == 3) echo 'style="display:block;"';
                                                                        else  echo 'style="display:none;"'; ?>>
                                    <div class="form-group">
                                        <?php
                                        $status = 0;
                            ...
                            <div class="form-group text-center font-karla m-b-0 p-t-10 m-t-15">
                                ...
                                <a href="schedule_content_list.php" class="btn btn-default waves-effect waves-light m-l-15" style="padding:6px 32px">
                                    Cancel
                                </a>
                            </div>
                        </form>
                ...
                <div class="modal-dialog" style="width:400px">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div class="row m-b-10 ">
                                <div class="col-md-6">
                                    <div>
                                        ...
                                        <img src="<?= $show_image ?>" class="img-circle thumb-sm" alt="Profile Pic" />
                                        <span class="m-l-10 font-assistant-bold"> <?= $_COOKIE['login_postedby'] ?></span>
                                        <p style="margin-left: 45px;margin-top: -10px;color:#A5AFA7">Just now</p>
                                    </div>
                                </div>
                            ...
                            <!--div class="row">
                                <div>Schedule Date: <span style="color:green" id="date"></span></div>
                            </div-->
                            ...
                            <div class="video-container m-b-15" id="show-video">
                                <div class="video-foreground">
                                    <iframe id="video-display" src="#" frameBorder="0" width="350" height="200">
                                    </iframe>
                                </div>
                            </div>
                        ...
                        <div class="modal-footer ">
                            <div class="text-center">
                                ...
                                <button type="submit" name="submit" class="btn btn-primary waves-effect waves-light" id="submit-data" form="db_entry_form">Save</button>
                            </div>
                        </div>
...
<script type="text/javascript">
    ...
    var errtime = document.getElementById("errScheduleTime");
    ...
    function scheduleTime(scheduleDate) {
        // alert('data' + scheduleDate);
        ...
        // currentDate = [year, month, day].join('-') + 'T' + [h, m].join(':');

        // if (scheduleDate >= currentDate) {
        //     // alert('valid');

        //     errtime.innerHTML = "";
        //     errtime.style.color = "none";
        // } else {
        //     // alert('invalid');
        //     errtime.innerHTML = "Choose valid date";
    ...
    $("#db_entry_form").submit(function(event) {
        ...
        if (type == 2 && numberOfChecked == 0) {
            ...
            if (db_entry_form.parsley().isValid() == true && errtitle.innerHTML == "" && errtime.innerHTML == "") {
                $("#myModal").modal("show");
                if (popupshow == false) {
            ...
            // d = new Date(document.getElementById("schedule-date").value);
            // alert(sc.toLocaleString());
            // document.getElementById("date").innerHTML = sc.toLocaleString();
        }
    });
    let imagename = '<?php echo $img_uploaded; ?>'
    $("#verborgen_file").change(function() {
    ...
    $(function() {
        ...
        // $('#schedule-date').val(new Date('DD/MM/YYYY h:mm a'));

        $('#schedule-date').on('dp.change', function(e) {
            var sd = new Date(new Date(e.date));
            // sc = sd;
            ...
            scheduleDate = [syear, smonth, sday].join('-') + 'T' + [sh, sm].join(':');
            // alert(scheduleDate);
