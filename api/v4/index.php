...
$app->post('/updateUserProfile', function() use ($app){
	...
	if($result[$TAG_SUCCESS]){
		...
		$query = "UPDATE `$NURSE_TABLE` SET `$NURSE_FIRST_NAME` = '$_fname', `$NURSE_LAST_NAME` = '$_lname', `$NURSE_DOB` = '$_dob', `$NURSE_GRADUATING_YEAR` = '$_graduation', `$NURSE_HOSPITAL_JOINING_DATE` = '$_joining_date', `$NURSE_DESIGNATION` = '$_designation', `$NURSE_TRAINER` = '$_trainer', `$NURSE_TOT_DATE` = '$_tot_date', `$NURSE_EDIT_TIME` = '$dateNow' WHERE `$NURSE_ID` = '$_user_id'";
		$result = mysqli_query($db_con,$query);	
