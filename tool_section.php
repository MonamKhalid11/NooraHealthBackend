...
$materialURL = '';
$isLink = 2;
$query1 = "SELECT " . $table_noora_ccp_tool_type . ".* FROM " . $table_noora_ccp_tool_type . " where " . $table_noora_ccp_tool_type . ".ID='$entry_id' limit 1";

$res1 = mysqli_query($link, $query1);
// if (mysqli_num_rows($res1) > 0) {
while ($row1 = mysqli_fetch_array($res1)) {
    $toolSection = $row1['Name'];
    ...
    <div class="navbar navbar-default" role="navigation">
        <div class="container">
            ...
            <ul class="nav navbar-nav navbar-left">
                ...
                <li>
                    <?php if ($entry_id == 0) { ?>
                        <h4 class="page-title font-karla">Add New Tool Section </h4>
                    <?php } else { ?>
                        <h4 class="page-title font-karla">Edit Tool Section </h4>
                    <?php } ?>
                </li>
            </ul>
            ...
            <div class="row">
                ...
                <div class="col-lg-8 screen">
                    <div class="card-box">
                        ...
                        <form id="db_entry_form" action="tool_section_entry.php" enctype="multipart/form-data" class="form-horizontal form-align" method="post" data-parsley-validate novalidate>
                            ...
                            <div class="row">
                                <div class="col-lg-11">
                                    <div class="form-group font-karla">
                                        <label for="toolSection">Name<span class="text-red">*</span></label>
                                        <input type="text" name="toolSection" parsley-trigger="change" required placeholder="Name" class="form-control" id="toolSection" value="<?= $toolSection; ?>">
                            ...
                            <div class="row">
                                <div class="col-lg-11">
                                    <div class="form-group font-karla">
                                        <label for="isLink">Is a link</label>
                                        <input type="checkbox" name="isLink"   style="width:17px;height:14px;display:block" id="isLink" >
                                        <span id="errtoolSectionName"></span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row" id="url" style="display:none">
                                <div class="col-lg-11">
                                    <div class="form-group font-karla">
                                        <label for="MaterialURL">Material URL<span class="text-red">*</span></label>
                            ...
                            <div class="form-group text-center font-karla m-b-0 p-t-10 m-t-15">
                                ...
                                <a href="tool_section_listing.php" class="btn btn-default waves-effect waves-light m-l-15" style="padding:6px 32px">
                                    Cancel
                                </a>
                            </div>
                        </form>
...
<script type="text/javascript">
    ...
    if(<?php echo $entry_id; ?> != 0)
    {
    if((<?php echo $isLink ?> != 2 ))
    {
        if(<?php echo $isLink; ?> == 0)
        {
